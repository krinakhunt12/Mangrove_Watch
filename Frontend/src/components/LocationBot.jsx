...
import { MapPin, Send, X, Bot, Loader2 } from "lucide-react";
  ...
  const [messages, setMessages] = useState([
    {
      id: 1,
      type: "bot",
      content: "Hello! I'm your Mangrove Watch assistant. Please enter a location or coordinates to check vegetation changes.",
      timestamp: new Date()
    }
  ]);
