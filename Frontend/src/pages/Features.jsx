...
const AnimatedFeatureCard = ({ emoji, title, description, delay }) => {
      ...
      <main className="flex-grow container mx-auto py-10 md:py-16 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12">
          <AnimatedFeatureCard
            ...
            description="Use our mobile app to report illegal cutting, dumping, or other threats to mangroves in your area."
            delay={0.1}
          />
          ...
          <AnimatedFeatureCard
            ...
            description="Our system verifies reports using satellite data and AI analysis to ensure accuracy and reliability."
            delay={0.3}
          />
          ...
          <AnimatedFeatureCard
            emoji="🏆"
            title="Earn Rewards"
            description="Collect points, climb the leaderboard, and earn rewards for your verified contributions to mangrove conservation."
            delay={0.5}
          />
        </div>

        {/* Animated connecting line for features */}
        <motion.div 
          initial={{ scaleX: 0 }}
        ...
        >
          <Link to="/login">
            <motion.button
              className="bg-green-600 hover:bg-green-700 text-white px-8 md:px-10 py-4 rounded-2xl shadow-md transition-all text-lg md:text-xl tracking-wide relative overflow-hidden group"
              whileHover={{ 
                scale: 1.05,
